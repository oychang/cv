...
\Entry
\href{https://www.moderntreasury.com}{\textbf{Modern Treasury}}, San Francisco, California
\Gap
\BulletItem Senior Software Engineer
\hfill \DatestampYM{2024}{03} -- \DatestampYM{2025}{03}
\begin{Detail}
\SubBulletItem Optimized GraphQL account search API using Postgres B-Tree GIN indexes and public product changes for a 100x decrease in latency for large customer edge cases
\SubBulletItem Updated edge routing service to use SQLite and S3 polling for dynamic routing changes, enabling non-technical users to onboard customers and enable multi-cell load balancing
\SubBulletItem Integrated merge queue on GitHub and Buildkite to avoid semantic merge conflicts with migrations and API contracts in a high velocity monolithic Ruby on Rails application
\end{Detail}
